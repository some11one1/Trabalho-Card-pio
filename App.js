...
const HomeDrawer = () => {
  ...
  const  confirmarLogout = () => {
    if (Platform.OS === 'web') { // se estiver rodando na web vai só mandar o prompt básico pra deslogar
  ...
  return (
    <Drawer.Navigator
      screenOptions={() => ({
        ...
        drawerStyle: { // muda a cor do drawer conforme o tema
    ...
    >
      ...
      <Drawer.Screen name= "sair" component={() => null} //componente nulo pq n tem tela pro logout
        options={{
          drawerLabel: "Sair" //nome que aparece no drawer
        }}
        listeners={{
          drawerItemPress: (e) => { //quando clicar no item do drawer
