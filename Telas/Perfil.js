...
export default function Perfil() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: tema.background }}>
      ...
      >
        <Text style={{ fontSize: 22, fontWeight: "600", color: corRecarregar }}>
          Recarregar
        </Text>
      </TouchableOpacity>
          ...
          >
            ...
            <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
              {["10", "25", "50", "100"].map((v) => (
                ...
                >
                  <Text style={{ color: tema.texto, fontSize: 18 }}>R${v}</Text>
                </TouchableOpacity>
              ))}
            </View>
            ...
            >
              <Text style={{ fontSize: 18, color: corFechar }}>Fechar</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
